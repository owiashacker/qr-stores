...
// Pending store-approval requests (new sign-ups awaiting super-admin review)
$pendingStoresCount = 0;
try {
    $pendingStoresCount = (int) $pdo->query("SELECT COUNT(*) FROM stores WHERE approval_status = 'pending'")->fetchColumn();
} catch (Throwable $e) { /* migration not yet applied — silently ignore */
}
        ...
        <aside id="sidebar" class="fixed md:sticky top-0 right-0 h-screen w-72 bg-[#0b1220] border-l border-white/5 z-40 sidebar-mobile-hidden md:transform-none overflow-y-auto scrollbar-hide">
            ...
            <nav class="p-4 space-y-1">
                ...
                $links = [
                    ...
                    ['stores', 'المتاجر', 'M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4', $pendingStoresCount],
                    ['affiliates', 'الوسطاء', 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z'],
